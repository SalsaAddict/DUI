...
dui.run(["$templateCache", "$log", function (
    ...
    $templateCache.put("duiForm.html",
        "<div class=\"panel panel-default dui-form\" ng-form=\"form\">" +
    ...
    $templateCache.put("duiFormTab.html",
        "<div id=\"tab{{index}}\" ng-show=\"isActive\" ng-form=\"form\">" +
        "<br /><div ng-transclude></div></div>");

    $templateCache.put("duiLabel.html",
        "<div class=\"form-group\" ng-class=\"{'has-error': hasError}\" ng-form=\"form\" " +
        "uib-tooltip=\"{{message}}\" tooltip-enable=\"hasError\">" +
    ...
    $templateCache.put("duiCurrency.html",
